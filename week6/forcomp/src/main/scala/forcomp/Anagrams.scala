...
object Anagrams {
   ...
   */
  def subtract(x: Occurrences, y: Occurrences): Occurrences = x.foldLeft(List[(Char, Int)]()) ((b,a) => if(a._1 == y.head._1) if(a._2 == y.head._2) b else b:::List((a._1, a._2-y.head._2)) else b ::: List(a))

//TODO: call method that returns how much to remove? or just returns the updated node?
